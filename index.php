...
if (! defined('BASE_URL')) {
    ...
    define('BASE_DIR', dirname(__FILE__) . '/');//BASE_DIR为根目录绝对路径
...
class BaseCore {
    ...
    protected function __construct()
    {
        ...
        include_once(COMMON_DIR . 'redis.php');
        $this->load = new LoadFile();
        $this->db = (new db())->redisConnect();
        session_start();
        $this->pdo  = (new pdoMysql())->connect();//phpverson>=5.4
    }
